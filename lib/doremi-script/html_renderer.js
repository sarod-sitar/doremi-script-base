(function() {
  ...
  draw_pitch = function(pitch) {
    var attribute, data1, lower_octave_symbol_html, my_source, pitch_sign, source2, syl_html, title, upper_attributes_html, upper_octave_symbol_html;
  ...
  draw_item = function(item) {
    var attribute, data1, my_source, source2, title, upper_attributes_html;
    ...
    return "<span title=\"" + title + "\" class=\"note_wrapper\" " + data1 + ">" + upper_attributes_html + "<span class=\"note " + item.my_type + "\" tabindex=\"0\">" + my_source + "</span></span>";
  };
