(function() {
  var Logger, aux1, debug, first_line, first_sargam_line, my_inspect, parse_without_reporting_error, parser, root, should_not_parse, sys, test_data, test_parses, utils, _;
  ...
  */
  ...
  test_data = ['  \nC/E\nS-', '', "Test accepts C/E chord"];
  exports.test_all2 = function(test) {
    var fun;
    fun = function(args) {
      var expected, msg, str, val;
      str = args[0], expected = args[1], msg = args[2];
      _.info("✔ Testing " + str + " -> " + expected);
      return val = test_parses(str, test, msg);
    };
