(function() {
  ...
  $(document).ready(function() {
    var debug, handleFileSelect, long_composition, my_url, params_for_download_lilypond, params_for_download_sargam, parser, str, str1, str_simple, zlong_composition;
    debug = false;
    ...
    $('#generate_html_page').click(__bind(function() {
      var composition, full_url, html_str, my_data, obj;
