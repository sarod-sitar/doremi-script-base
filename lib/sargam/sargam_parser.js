  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "LOGICAL_LINE": parse_LOGICAL_LINE,
        "LOGICAL_LINE_END": parse_LOGICAL_LINE_END,
      ...
      function parse_EMPTY_LINE() {
        ...
        var result0 = result1 !== null
          ? (function() { return {my_type: "logical_line_end"}
                     })()
          : null;
      ...
      function parse_HEADER_SECTION() {
          ...
          if (result8 !== null) {
            ...
            if (result7 !== null) {
              ...
              if (result6 !== null) {
                ...
                reportMatchFailures = false;
                var result5 = parse_LOGICAL_LINE();
        ...
        if (reportMatchFailures && result0 === null) {
          matchFailed("Headers followed by blank lines or a logical line");
        }
      ...
      function parse_COMPOSITION() {
        ...
        if (result2 !== null) {
          var result3 = [];
          var result11 = parse_EMPTY_LINE();
          while (result11 !== null) {
            result3.push(result11);
            var result11 = parse_EMPTY_LINE();
          }
          if (result3 !== null) {
            var result10 = parse_HEADER_SECTION();
            var result4 = result10 !== null ? result10 : '';
            if (result4 !== null) {
              var result5 = [];
              var result9 = parse_LOGICAL_LINE();
              while (result9 !== null) {
        ...
        reportMatchFailures = savedReportMatchFailures;
        if (reportMatchFailures && result0 === null) {
          matchFailed("a musical piece  lines:LOGICAL_LINE+ ");
        }
      ...
      function parse_LOGICAL_LINE_END() {
        var cacheKey = 'LOGICAL_LINE_END@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_LOGICAL_LINE() {
        ...
        var savedPos0 = pos;
        var result2 = [];
        var result12 = parse_UPPER_OCTAVE_LINE();
        while (result12 !== null) {
          result2.push(result12);
          var result12 = parse_UPPER_OCTAVE_LINE();
        }
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            ...
            if (result4 !== null) {
              ...
              if (result5 !== null) {
                var result6 = parse_LOGICAL_LINE_END();
                if (result6 !== null) {
                  var result1 = [result2, result3, result4, result5, result6];
                } else {
                  var result1 = null;
        ...
        reportMatchFailures = savedReportMatchFailures;
        if (reportMatchFailures && result0 === null) {
          matchFailed("multiple lines including syllables etc,delimited by empty line. There is an order, optional upper octave lines followed by main line of sargam followed by optional lyrics line");
        }
      ...
      function parse_UPPER_OCTAVE_LINE() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result4 = parse_UPPER_OCTAVE_LINE_ITEM();
        if (result4 !== null) {
          var result2 = [];
          while (result4 !== null) {
      ...
      function parse_CHORD_SYMBOL() {
        ...
        reportMatchFailures = savedReportMatchFailures;
        if (reportMatchFailures && result0 === null) {
          matchFailed("I IV V. TODO: review");
        }
      ...
      function parse_LOWER_OCTAVE_LINE() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result4 = parse_LOWER_OCTAVE_LINE_ITEM();
        if (result4 !== null) {
          var result2 = [];
          while (result4 !== null) {
            result2.push(result4);
      ...
      function parse_ABC_MEASURE() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result9 = parse_BARLINE();
        var result2 = result9 !== null ? result9 : '';
        if (result2 !== null) {
          var result8 = parse_ABC_NON_BARLINE();
          if (result8 !== null) {
            var result3 = [];
            while (result8 !== null) {
      ...
      function parse_DEVANAGRI_MEASURE() {
        ...
        var result2 = result9 !== null ? result9 : '';
        if (result2 !== null) {
          var result8 = parse_DEVANAGRI_NON_BARLINE();
          if (result8 !== null) {
            var result3 = [];
            while (result8 !== null) {
              result3.push(result8);
      ...
      function parse_ABC_SARGAM_LINE() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result6 = parse_LINE_NUMBER();
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result5 = parse_ABC_MEASURE();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
      ...
      function parse_DEVANAGRI_SARGAM_LINE() {
        ...
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result5 = parse_DEVANAGRI_MEASURE();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
      ...
      function parse_ABC_BEAT_UNDELIMITED() {
        ...
        var savedReportMatchFailures = reportMatchFailures;
        reportMatchFailures = false;
        var result2 = parse_ABC_BEAT_UNDELIMITED_ITEM();
        if (result2 !== null) {
          var result1 = [];
          while (result2 !== null) {
      ...
      function parse_BEAT_UNDELIMITED() {
        ...
        var savedReportMatchFailures = reportMatchFailures;
        reportMatchFailures = false;
        var result2 = parse_BEAT_UNDELIMITED_ITEM();
        if (result2 !== null) {
          var result1 = [];
          while (result2 !== null) {
            result1.push(result2);
      ...
      function parse_DEVANAGRI_BEAT_UNDELIMITED() {
        ...
        var savedReportMatchFailures = reportMatchFailures;
        reportMatchFailures = false;
        var result2 = parse_DEVANAGRI_BEAT_UNDELIMITED_ITEM();
        if (result2 !== null) {
          var result1 = [];
          while (result2 !== null) {
            result1.push(result2);
      ...
      function parse_ABC_BEAT_DELIMITED() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result2 = parse_BEGIN_BEAT_SYMBOL();
        if (result2 !== null) {
          var result5 = parse_ABC_BEAT_DELIMITED_ITEM();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
          ...
          if (result3 !== null) {
            var result4 = parse_END_BEAT_SYMBOL();
            if (result4 !== null) {
              var result1 = [result2, result3, result4];
            } else {
              var result1 = null;
      ...
      function parse_DEVANAGRI_BEAT_DELIMITED() {
        ...
        var result2 = parse_BEGIN_BEAT_SYMBOL();
        if (result2 !== null) {
          var result5 = parse_DEVANAGRI_BEAT_DELIMITED_ITEM();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
      ...
      function parse_BEAT_DELIMITED() {
        ...
        var result2 = parse_BEGIN_BEAT_SYMBOL();
        if (result2 !== null) {
          var result5 = parse_BEAT_DELIMITED_ITEM();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
      ...
      function parse_ABC_SARGAM_PITCH() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result6 = parse_BEGIN_SLUR_OF_PITCH();
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result3 = parse_ABC_MUSICAL_CHAR();
          if (result3 !== null) {
            var result5 = parse_END_SLUR_OF_PITCH();
      ...
      function parse_DEVANAGRI_SARGAM_PITCH() {
        ...
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result3 = parse_DEVANAGRI_MUSICAL_CHAR();
          if (result3 !== null) {
            var result5 = parse_END_SLUR_OF_PITCH();
            var result4 = result5 !== null ? result5 : '';
            if (result4 !== null) {
      ...
      function parse_SARGAM_PITCH() {
        ...
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result3 = parse_SARGAM_MUSICAL_CHAR();
          if (result3 !== null) {
            var result5 = parse_END_SLUR_OF_PITCH();
            var result4 = result5 !== null ? result5 : '';
            if (result4 !== null) {
      ...
      function parse_BARLINE() {
        ...
        var savedReportMatchFailures = reportMatchFailures;
        reportMatchFailures = false;
        var result7 = parse_REVERSE_FINAL_BARLINE();
        if (result7 !== null) {
          var result0 = result7;
        } else {
          var result6 = parse_FINAL_BARLINE();
          if (result6 !== null) {
            var result0 = result6;
          } else {
            var result5 = parse_DOUBLE_BARLINE();
            if (result5 !== null) {
              var result0 = result5;
            } else {
              var result4 = parse_LEFT_REPEAT();
              if (result4 !== null) {
                var result0 = result4;
              } else {
                var result3 = parse_RIGHT_REPEAT();
                if (result3 !== null) {
                  var result0 = result3;
                } else {
