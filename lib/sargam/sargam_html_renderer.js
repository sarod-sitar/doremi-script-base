(function() {
  var draw_attributes, draw_beat, draw_item, draw_line, draw_lower_sym, draw_measure, draw_ornament, draw_syllable, draw_upper_sym, id_ctr, last_slur_id, lookup_html_entity, root, to_html, to_html_doc;
      ...
      upper_attributes_html = ((function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(__bind(function(attribute) {
            ...
            if (attribute.my_type === "zzornament") {
