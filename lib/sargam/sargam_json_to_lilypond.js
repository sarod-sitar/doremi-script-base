(function() {
  var all_items_in_line, calculate_lilypond_duration, debug, extract_lyrics, fraction_to_lilypond, get_attribute, is_valid_key, lilypond_barline_map, lilypond_octave_map, lilypond_pitch_map, log, my_inspect, normalized_pitch_to_lilypond, root, running_under_node, to_lilypond;
  ...
  to_lilypond = function(composition_data) {
    var all, ary, at_beginning_of_first_measure_of_line, bar, beat, composer, composer_snippet, dash, dash_array, in_times, item, lilypond_template, logical_line, measure, mode, my_mode, notes, obj, orig, src, src1, time, title, title_snippet, transpose_snip, x, _i, _j, _k, _len, _len2, _len3, _ref, _ref2;
    ary = [];
    in_times = false;
