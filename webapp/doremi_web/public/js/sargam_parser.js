  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_NUMBER_MEASURE() {
        ...
        var result2 = result9 !== null ? result9 : '';
        if (result2 !== null) {
          var result8 = parse_NUMBER_NON_BARLINE();
          if (result8 !== null) {
            var result3 = [];
            while (result8 !== null) {
              result3.push(result8);
      ...
      function parse_NUMBER_NON_BARLINE() {
        ...
        if (result7 !== null) {
          ...
          var result6 = parse_NUMBER_BEAT_DELIMITED();
          if (result6 !== null) {
            var result0 = result6;
          } else {
            var result5 = parse_NUMBER_BEAT_UNDELIMITED();
            if (result5 !== null) {
              var result0 = result5;
            } else {
              var result4 = parse_NUMBER_SARGAM_PITCH();
              if (result4 !== null) {
                var result0 = result4;
              } else {
                var result3 = parse_RHYTHMICAL_DASH();
      ...
      function parse_NUMBER_SARGAM_LINE() {
        ...
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result5 = parse_NUMBER_MEASURE();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
      ...
      function parse_NUMBER_BEAT_UNDELIMITED() {
        ...
        var savedReportMatchFailures = reportMatchFailures;
        reportMatchFailures = false;
        var result2 = parse_NUMBER_BEAT_UNDELIMITED_ITEM();
        if (result2 !== null) {
          var result1 = [];
          while (result2 !== null) {
            result1.push(result2);
      ...
      function parse_NUMBER_BEAT_DELIMITED() {
        ...
        var result2 = parse_BEGIN_BEAT_SYMBOL();
        if (result2 !== null) {
          var result5 = parse_NUMBER_BEAT_DELIMITED_ITEM();
          if (result5 !== null) {
            var result3 = [];
            while (result5 !== null) {
              result3.push(result5);
      ...
      function parse_NUMBER_SARGAM_PITCH() {
        ...
        var result2 = result6 !== null ? result6 : '';
        if (result2 !== null) {
          var result3 = parse_NUMBER_MUSICAL_CHAR();
          if (result3 !== null) {
