(function() {
  ...
  draw_lyrics_section = function(lyrics_section) {
    ...
    return x + ("<div title='Lyrics Section' data-bind='css:{hide_hyphenated_lyrics:hide_hyphenated_lyrics}' class='stave lyrics_section hyphenated'>" + lyrics_section.hyphenated_source + "</div>");
  };
